...
/*********************************************    SKU    **************************************************************/
Route::prefix('admin/sku')->middleware('checklogin')->group(function(){
    Route::get('create_key','admin\SkuController@create_key');          // 商品固有属性添加
    Route::post('save_key','admin\SkuController@save_key');             // 商品固有属性添加
});
/*********************************************    SKU    **************************************************************/
